...
mainForm1 = [
    ...
    { label: '合同金额', field: 'contAmount', com: Select, required: true, data: [{ key: '约定日起租', value: '0' }] },
    { label: '租赁方式', field: 'leaseType', com: DatePicker, required: true, format: 'YYYY-MM-DD' },
    { label: '实际放款金额（汇总）', field: 'actualLoanAmount', com: DatePicker, required: true, format: 'YYYY-MM-DD' },
    { label: '付款帐号', field: 'paymentAccount', com: DatePicker, required: true, format: 'YYYY-MM-DD' },
    { label: '币种', field: 'pkCurrency', com: DatePicker, required: true, format: 'YYYY-MM-DD' },
