...
class ListView extends Component {
    ...
    grid = [
        ...
        { title: '证件类型', key: 'identityType', type: '6',enumType:'identityType' },
        ...
        { title: '性别', key: 'sex', type: '6' ,enumType:'sex'},
        { title: '文化程度', key: 'levelOfEducation', type: '6',enumType:'education' },
        { title: '联系方式', key: 'contact', type: '0' },
        { title: '婚姻状况', key: 'marryStatus', type: '1',enumType:'marryStatus' },
        { title: '子女情况', key: 'childrenStatus', type: '0' },
        { title: '子女上学情况', key: 'childrenSchoolStatus', type: '0' },
        { title: '行业类型', key: 'industryType', type: '0' },
        { title: '职称', key: 'officalTitle', type: '6',enumType:'profess' },
        { title: '职业', key: 'job', type: '0' },
        ...
        { title: '本单位工作年限', key: 'lengthOfService', type: '6',enumType:'lengthOfJob'  },
        { title: '本地居住年限(年)', key: 'lengthLocalResidence', type: '6' ,enumType:'lengthOfJob'},
        { title: '是否有房产', key: 'realEstate', type: '6',enumType:'yesOrNo' },
        ...
        { title: '联系人与承租人关系', key: 'linkmanLesseeRelationship', type: '6',enumType:'relationship' },
        { title: '联系人居住地址', key: 'linkmanAddress', type: '0' },
        { title: '配偶姓名', key: 'spouseName', type: '0' },
        { title: '配偶证件类型', key: 'spouseIdentityType', type: '1' },
        { title: '配偶证件号码', key: 'spouseIdentityNo', type: '0' },
        { title: '配偶年龄', key: 'spouseAge', type: '1' },
        { title: '配偶联系方式', key: 'spouseContact', type: '0' },
        { title: '配偶文化程度', key: 'spouseLevelEducation', type: '6',enumType:'education' },
        ...
        { title: '担保人证件类型', key: 'guarantorIdentityType', type: '6',enumType:'identityType'  },
        { title: '担保人证件号', key: 'guarantorIdentityNo', type: '0' },
        { title: '担保人出生日期', key: 'guarantorBirthday', type: '3' },
        { title: '担保人性别', key: 'guarantorSex', type: '1' },
        ...
        { title: '担保人婚姻状况', key: 'guarantorMarryStatus', type: '6',enumType:'marryStatus' },
