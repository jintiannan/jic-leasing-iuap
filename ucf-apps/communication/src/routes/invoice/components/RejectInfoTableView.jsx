...
const addTitle = "驳回意见表";       //模态框标题

class RejectInfoTableView extends Component {
    constructor(props) {
    ...
    componentDidMount() {
        this.props.onRejectInfoListRef(this);
    }
    ...
    getList = (Obj) => {
        actions.communicationInvoice.getListRejectInfo(Obj);
    }

    //关闭模态框
    close = () => {
        actions.communicationInvoice.updateState({ showRejectInfoTableModal: false });
    }

    //主表  列属性定义 ifshow:false 不显示该列  默认全显示 true
    grid = [
        { title: '驳回时间', key: 'operateTime', type: '0', width: '150', sorter: 0 },
        { title: '驳回人', key: 'pkOperator.userName', type: '0', width: '120', sorter: 0 },
        { title: '驳回意见', key: 'rejectInfo', type: '0', width: '500', sorter: 0},
    ]
    //主表 列属性定义=>通过前端service工具类自动生成
    gridColumn = [];

    render() {
        if (this.props.showRejectInfoTableModal == false) {
            return <div></div>;
        } else {
            return (
                <div>
                    ...
                    <Modal
                        className="jic-model"
                        show={this.props.showRejectInfoTableModal}
                        ...
                        <Modal.Body >
                            ...
                            <div className="steps-content">
                                ...
                                <GridMain
                                    ...
                                    data={this.props.rejectInfoList} //数据数组                     
...
export default Form.createForm()(RejectInfoTableView);