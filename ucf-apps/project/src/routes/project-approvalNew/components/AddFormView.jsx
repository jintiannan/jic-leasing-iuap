        ...
        <div style={{display:this.state.showProject}}>
                            ...
                            <FormItem>
                                ...
                                <FormControl
                                    ...
                                    ...getFieldProps('project_filing_name', {
                                        initialValue: formObjAdd.project_filing_name,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                            ...
                            <FormItem>
                                ...
                                <FormControl
                                    ...
                                    ...getFieldProps('project_filing_code', {
                                        initialValue: formObjAdd.project_filing_code,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('project_filing_num', {
                                        initialValue: formObjAdd.project_filing_num,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('project_filing_from', {
                                        initialValue: formObjAdd.project_filing_from,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('project_filing_type', {
                                        initialValue: formObjAdd.project_filing_type ,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('leasback_type', {
                                        initialValue: formObjAdd.leasback_type ,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('lease_type', {
                                        initialValue: formObjAdd.lease_type,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('calculator_type', {
                                        initialValue: formObjAdd.calculator_type ,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                        ...
                        <Col md={4} xs={4} sm={4}>
                            <FormItem>
                                ...
                                <FormControl
                                    {
                                    ...getFieldProps('project_amount', {
                                        initialValue: formObjAdd.project_amount,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
                            ...
                            <FormItem>
                                ...
                                <FormControl
                                    ...
                                    ...getFieldProps('project_manager', {
                                        initialValue: formObjAdd.project_manager,
                                        rules: [{
                                            required: true, 
                                        }],
                                    })
