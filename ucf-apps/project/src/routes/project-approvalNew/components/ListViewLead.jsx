...
class ListViewLead extends Component {
    ...
    //列属性定义
    grid = [
        {title:'单据状态',key:'project_approve_result',type:'0'},
    ...
    gridColumn = [];
        ...
        //列属性定义
        grid2 = [
            {title:'会议期数2',key:'meetingnper',type:'1'},
            {title:'承租人名称2',key:'pk_consumer.name',type:'0'},
            {title:'承租人编码2',key:'pk_consumer.code',type:'0'},
            {title:'单据状态2',key:'billstatus',type:'6',enumType:'billstatus'},
            {title:'项目名称2',key:'project_name',type:'0'},
            {title:'项目编号2',key:'project_code',type:'0'},
        ]
        //列属性定义=>通过前端service工具类自动生成
        gridColumn2 = [];
