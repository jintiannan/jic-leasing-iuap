...
class ListView extends Component {
    ...
    grid = [
        ...
        {title: '项目经理', key: 'pk_prj_manager.name', type: '0'},
        {title: '项目分类', key: 'project_sort', type: '0'},
        {title: '确认业务领域', key: 'industry_type', type: '0'},
        {title: '是否项目合同一一对应', key: 'is_onetoone', type: '0'},
        {title: '项目主办人', key: 'pk_cust_main.name', type: '0'},
        {title: '项目协办人', key: 'pk_cust_help.name', type: '0'},
        {title: '出租方账户', key: 'pk_account.code', type: '0'},
        ...
        {title: '所属公司', key: 'pk_pro_org.name', type: '0'},
        {title: '授信分类', key: 'limit_class', type: '0'},
        ...
        {title: '供应商合作协议', key: 'pk_framework_agreem.name', type: '0'},
        {title: '供应商限额方案', key: 'pk_quota_scheme.name', type: '0'},
        ...
        {title: '审批文档生成规则', key: 'pk_contract_rule.name', type: '0'},
