...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.projectSource.updateState({showLoading: true});
            ...
            actions.projectSource.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().projectSource.list;
            ...
            actions.projectSource.updateState({list:_list});
        },
    }
};
