...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.projectSource.loadList(this.props.queryParam);
    }
    ...
    freshData = (pageIndex) => {
        ...
        actions.projectSource.loadList(queryParam);
    }
    ...
    //     }
    //     actions.projectSource.updateRowData(param,index);
    //     actions.projectSource.updateState({ selectedList : _selectedList });
    ...
    getSelectedDataFunc = (selectedList,record,index) => {
        ...
        if(_selectedList && _selectedList.length == 1){
            ...
            actions.projectSource.updateState({ list2 : []});
        }


        actions.projectSource.updateState({ list : _list,selectedList : _selectedList,formObject : _formObj});
    ...
    childList = (obj) => {
        console.log("进入" + obj);
        //加载子组件列表
        actions.projectSource.loadChildList(this.props.queryParam);
    }
    ...
    render() {
        ...
        return (
            this.props.subForm === 'projectSource'?
