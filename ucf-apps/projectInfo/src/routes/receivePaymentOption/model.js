...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.receivePaymentOption.updateState({showLoading: true});
            ...
            actions.receivePaymentOption.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().receivePaymentOption.list;
            ...
            actions.receivePaymentOption.updateState({list:_list});
        },
    }
};
