                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <Select
                                                        ...
                                                        disabled={true}
                                                        {
                                                            ...getFieldProps('lesseeType', {
                                                                initialvalue: _formObject.lesseeType,
                                                            })
                                                        }
                                                    />
                                                </FormItem>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkConsumer.informAddressZip', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkConsumer.companyMailbox', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                    ...
                                    <div style={{display:this.state.showDiv2}}>
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={!this.props.isEdit}
                                                                 {
                                                                     ...getFieldProps('pkAccountLessee.name', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkAccountLessee.code', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkAccountLessee.accountBank', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Col md={4} xs={4} sm={4}>
                                            <FormItem>
                                                ...
                                                <FormControl disabled={true}
                                                             {
                                                                 ...getFieldProps('pkAccountLessee.bankNo', {
                                                                     initialValue: '',
                                                                     rules: [{
                                                                         required: true,
                                                                     }],
