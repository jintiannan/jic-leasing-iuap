...
class AddFormView extends Component {
    ...
    close() {
        actions.projectBothLessee.updateState({showModal : false});
        this.initDiv();
    }
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <Select
                                                        ...
                                                        disabled={true}
                                                        {
                                                            ...getFieldProps('lessee_type', {
                                                                initialValue: _formObject.lessee_type,
                                                            })
                                                        }
                                                    />
                                                </FormItem>
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_consumer.inform_address_zip', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Row>
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_consumer.company_mailbox', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                    ...
                                    <div style={{display:this.state.showDiv2}}>
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={!this.props.isEdit}
                                                                 {
                                                                     ...getFieldProps('pk_account_lessee.name', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_account_lessee.code', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_account_lessee.account_bank', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Col md={4} xs={4} sm={4}>
                                            <FormItem>
                                                ...
                                                <FormControl disabled={true}
                                                             {
                                                                 ...getFieldProps('pk_account_lessee.bank_no', {
                                                                     initialValue: '',
                                                                     rules: [{
                                                                         required: true,
                                                                     }],
