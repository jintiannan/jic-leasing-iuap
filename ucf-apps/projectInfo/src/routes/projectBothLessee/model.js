...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.projectBothLessee.updateState({showLoading: true});
            ...
            actions.projectBothLessee.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().projectBothLessee.list;
            ...
            actions.projectBothLessee.updateState({list:_list});
        },
    }
};
