...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.projectPledge.updateState({showLoading: true});
            ...
            actions.projectPledge.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().projectPledge.list;
            ...
            actions.projectPledge.updateState({list:_list});
        },
    }
};
