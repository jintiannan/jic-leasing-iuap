...
class FormView extends Component {
    ...
    form = [
        {label:'担保客户名称',field:'pk_customer',com:TableFormRef},
        {label:'担保客户编号',field:'pk_customer.code',com:FormControl, disabled: true},
        {label:'证件类型',field:'pk_customer.identity_type',com:Select, data: enumConstant(""), disabled: true},
        {label:'证件号码',field:'pk_customer.identity_no',com:FormControl, disabled: true},
        {label:'贷款卡号',field:'pk_customer.loan_card_no',com:FormControl, disabled: true},
        ...
        {label:'担保方式',field:'guarantee_method',com:Select, data: enumConstant("")},
        {label:'保证担保形式',field:'guarantee_type',com:Select, data: enumConstant("")},
        {label:'合同有效状态',field:'cont_valid_status',com:Select, data: enumConstant("")},
        {label:'客户关系',field:'relation_role',com:TableFormRef},
        {label:'债权方',field:'bond_bank',com:FormControl, disabled: true},
        {label:'担保金额（元）',field:'plan_cash',com:FormControl},
        {label:'担保合同是否上报征信',field:'credit_investigation',com:Select, data: enumConstant("")},
