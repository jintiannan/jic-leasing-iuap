                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <Select
                                                        ...
                                                        disabled={true}
                                                        {
                                                            ...getFieldProps('pkCustomer.identityType', {
                                                                initialValue: '',
                                                            })
                                                        }
                                                    />
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkCustomer.identityNo', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkCustomer.legalRep', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkCustomer.commAddress', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pkCustomer.commAddressZip', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
