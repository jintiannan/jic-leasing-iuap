...
class AddFormView extends Component {
    ...
    close() {
        actions.projectPledge.updateState({showModal : false});
        this.initDiv();
    }
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <Select
                                                        ...
                                                        disabled={true}
                                                        {
                                                            ...getFieldProps('pk_customer.identity_type', {
                                                                initialValue: '',
                                                            })
                                                        }
                                                    />
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_customer.identity_no', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_customer.legal_rep', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                        ...
                                        <Row>
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_customer.comm_address', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <FormControl disabled={true}
                                                                 {
                                                                     ...getFieldProps('pk_customer.comm_address_zip', {
                                                                         initialValue: '',
                                                                         rules: [{
                                                                             required: true,
                                                                         }],
                                            ...
                                            <Col md={4} xs={4} sm={4}>
                                                <FormItem>
                                                    ...
                                                    <Select
                                                        ...
                                                        {
                                                            ...getFieldProps('guarantee_method', {
                                                                initialValue: '',
                                                            })
                                                        }
                                                    />
