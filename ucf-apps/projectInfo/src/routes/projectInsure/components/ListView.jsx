...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.projectInsure.loadList(this.props.queryParam);
    }
    ...
    freshData = (pageIndex) => {
        ...
        actions.projectInsure.loadList(queryParam);
    }
    ...
    //     }
    //     actions.projectInsure.updateRowData(param,index);
    //     actions.projectInsure.updateState({ selectedList : _selectedList });
    ...
    getSelectedDataFunc = (selectedList,record,index) => {
        ...
        if(_selectedList && _selectedList.length == 1){
            ...
            actions.projectInsure.updateState({ list2 : []});
        }


        actions.projectInsure.updateState({ list : _list,selectedList : _selectedList,formObject : _formObj});
    ...
    childList = (obj) => {
        console.log("进入" + obj);
        //加载子组件列表
        actions.projectInsure.loadChildList(this.props.queryParam);
    }
    ...
    render() {
        ...
        return (
            this.props.subForm === 'projectInsure'?
