...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.penaltyRuleDetail.updateState({showLoading: true});
            ...
            actions.penaltyRuleDetail.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().penaltyRuleDetail.list;
            ...
            actions.penaltyRuleDetail.updateState({list:_list});
        },
    }
};
