...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.paymentCondition.updateState({showLoading: true});
            ...
            actions.paymentCondition.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().paymentCondition.list;
            ...
            actions.paymentCondition.updateState({list:_list});
        },
    }
};
