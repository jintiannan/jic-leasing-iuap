...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.paymentCondition.loadList(this.props.queryParam);
    }
    ...
    freshData = (pageIndex) => {
        ...
        actions.paymentCondition.loadList(queryParam);
    }
    ...
    //     }
    //     actions.paymentCondition.updateRowData(param,index);
    ...
    childList = (obj) => {
        console.log("进入" + obj);
        //加载子组件列表
        actions.paymentCondition.loadChildList(this.props.queryParam);
    }
