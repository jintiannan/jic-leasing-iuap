...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.projectLeader.updateState({showLoading: true});
            ...
            actions.projectLeader.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().projectLeader.list;
            ...
            actions.projectLeader.updateState({list:_list});
        },
    }
};
