...
class ListView extends Component {
    ...
    componentDidMount() {
        actions.rentCondition.loadList(this.props.queryParam);
    }
    ...
    freshData = (pageIndex) => {
        ...
        actions.rentCondition.loadList(queryParam);
    }
    ...
    //     }
    //     actions.rentCondition.updateRowData(param,index);
    //     actions.rentCondition.updateState({ selectedList : _selectedList });
    ...
    getSelectedDataFunc = (selectedList,record,index) => {
        ...
        if(_selectedList && _selectedList.length == 1){
            ...
            actions.rentCondition.updateState({ list2 : []});
        }


        actions.rentCondition.updateState({ list : _list,selectedList : _selectedList,formObject : _formObj});
    ...
    childList = (obj) => {
        console.log("进入" + obj);
        //加载子组件列表
        actions.rentCondition.loadChildList(this.props.queryParam);
    }
    ...
    render() {
        ...
        return (
            this.props.subForm === 'rentCondition'?
