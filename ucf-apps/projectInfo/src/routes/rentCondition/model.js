...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.rentCondition.updateState({showLoading: true});
            ...
            actions.rentCondition.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().rentCondition.list;
            ...
            actions.rentCondition.updateState({list:_list});
        },
    }
};
