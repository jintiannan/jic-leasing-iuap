...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.contProvider.updateState({showLoading: true});
            ...
            actions.contProvider.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().contProvider.list;
            ...
            actions.contProvider.updateState({list:_list});
        },
    }
};
