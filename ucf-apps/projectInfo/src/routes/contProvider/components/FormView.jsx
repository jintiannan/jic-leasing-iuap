...
class FormView extends Component {
    ...
    form = [
        {label:'项目名称',field:'pkProject.name',com:TableFormRef, disabled: true},
        {label:'项目编号',field:'pkProject.code',com:FormControl, disabled: true},
        {label:'合同名称',field:'contractName',com:FormControl},
        {label:'合同编号',field:'contractCode',com:FormControl},
        // {label:'合同签订日',field:'contractSigned.name',com:TableFormRef},
        {label:'合同金额',field:'contractAmount',com:FormControl},
        {label:'租赁物折让价',field:'lesseeAssignment',com:FormControl, disabled: true},
        {label:'设备金额',field:'facilityAmount',com:FormControl, disabled: true},
        {label:'承租人',field:'pkLinkman.name',com:TableFormRef},
        {label:'承租人编号',field:'pkLinkman.code',com:FormControl, disabled: true},
        {label:'法定代表人',field:'pkLinkman.legalRep',com:FormControl, disabled: true},
        {label:'地址',field:'pkLinkman.commAddress',com:FormControl, disabled: true},
        {label:'邮编',field:'pkLinkman.commAddressZip',com:FormControl, disabled: true},
        {label:'纳税人识别号',field:'pkLinkman.nationalTax',com:FormControl, disabled: true},
        {label:'卖方名称',field:'pkCustomerSales',com:TableFormRef},
        {label:'卖方客户编号',field:'pkCustomerSales.code',com:FormControl, disabled: true},
        {label:'法定代表人',field:'pkCustomerSales.legalRep',com:FormControl, disabled: true},
        {label:'地址',field:'pkCustomerSales.commAddress',com:FormControl, disabled: true},
        {label:'邮编',field:'pkCustomerSales.commAddressZip',com:FormControl, disabled: true},
        {label:'纳税人识别号',field:'pkCustomerSales.nationalTax',com:FormControl, disabled: true},
        {label:'供应商开票方式',field:'invoiceWay',com:Select, data: enumConstant("")},
        {label:'供应商纳税主体',field:'taxesMain',com:Select, data: enumConstant("")},
        {label:'发票性质',field:'invoiceNature',com:Select, data: enumConstant("")},
        {label:'税率',field:'taxRate',com:Select, data: enumConstant("")},
        {label:'合同类型',field:'contType',com:Select, data: enumConstant("")},
        {label:'合同状态',field:'contStatus',com:Select, data: enumConstant(""), disabled: true},
        {label:'所属公司',field:'pkGlorgbook.name',com:TableFormRef, disabled: true},
        {label:'币种',field:'pkCurrency.name',com:TableFormRef},
        {label:'备注',field:'memo',com:FormControl, col: 12, class: 'textarea'}
    ]

    form1 = [
        {label:'账户名称',field:'pkProvAccount.name',com:TableFormRef},
        {label:'账号',field:'pkProvAccount.code',com:FormControl, disabled: true},
        {label:'开户银行',field:'pkProvAccount.accountBank',com:FormControl, disabled: true},
        {label:'开户银行行号',field:'pkProvAccount.bankNo',com:FormControl, disabled: true},
    ]

    form2 = [
        {label:'账户名称',field:'pkLesseeAccount.name',com:TableFormRef},
        {label:'账号',field:'pkLesseeAccount.code',com:FormControl, disabled: true},
        {label:'开户银行',field:'pkLesseeAccount.accountBank',com:FormControl, disabled: true},
        {label:'开户银行行号',field:'pkLesseeAccount.bankNo',com:FormControl, disabled: true},
    ]

    form3 = [
        {label:'账户名称',field:'pkRentAccount.name',com:TableFormRef},
        {label:'账号',field:'pkRentAccount.code',com:FormControl, disabled: true},
        {label:'开户银行',field:'pkRentAccount.accountBank',com:FormControl, disabled: true},
        {label:'开户银行行号',field:'pkRentAccount.bankNo',com:FormControl, disabled: true},
