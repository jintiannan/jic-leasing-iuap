...
class IndexView extends Component {
    ...
    componentWillMount() {
        actions.customerCorpApply.updateState({powerButton:this.props.powerButton});
        actions.customerCorpApply.updateState({ifPowerBtn:this.props.ifPowerBtn});
    }
    ...
    switchToListView = () =>{
        ...
        actions.customerCorpApply.updateState({ formObject : {},isGrid : true,isEdit : false});
    };
    ...
    switchToCardView = (obj) =>{
        ...
        actions.customerCorpApply.updateState({ formObject : _formObj,isGrid : false,isEdit : false});
    };
    ...
    switchEdit = () =>{
        ...
        actions.customerCorpApply.updateState({isEdit : !this.state.isEdit});
    };
    ...
    onView = () =>{
        singleRecordOper(this.props.selectedList,(param) => {
            this.switchToCardView(param);
            actions.customerCorpApply.updateState({bt:false});
        });
    };
    ...
    onSave = () => {
        actions.customerCorpApply.saveOrUpdate(this.props.formObject);
    ...
    onDelete = () => {
        singleRecordOper(this.props.selectedList,(param) => {
            ...
            actions.customerCorpApply.delete(_selected.role_code);
        });
    };
     ...
     */
    onAdd = () =>{
        actions.customerCorpApply.updateState({showModal : true, isEdit: true});
    };
    render() {
        let ButtonPower = {
