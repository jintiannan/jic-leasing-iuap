...
class AddFormView extends Component {
    ...
    onSubSave = () => {
        ...
        actions.customerCorpApply.updateState({list: newRole, showModal: false, isEdit: false});
    };

    close = () => {
        actions.customerCorpApply.updateState({showModal: false, isEdit: false});
    };
    changeDropup = (state) => {
        this.setState({
            modalDropup: state
    ...
    prevController = () => {
        ...
        let lastShow = stepsName + oldCurrent;
        let nextShow = stepsName + this.state.current;
        let map = {};
        map[nextShow] = 'none';
        map[lastShow] = '';
        this.setState(map);
    ...
    nextController = () => {
        ...
        let lastShow = stepsName + oldCurrent;
        let nextShow = stepsName + (this.state.current + 1);
        let map = {};
        map[lastShow] = 'none';
        map[nextShow] = '';
        this.setState(map);
                                    ...
                                    {/*<Row>*/}
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('finance_related', {*/}
                                                                     {/*initialValue: _formObject.finance_related,*/}
                                        ...
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('equipment_related', {*/}
                                                                     {/*initialValue: _formObject.equipment_related,*/}
                                        ...
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('other_dept', {*/}
                                                                     {/*initialValue: _formObject.other_dept,*/}
                                    ...
                                    {/*<Row>*/}
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('government_related', {*/}
                                                                     {/*initialValue: _formObject.government_related,*/}
                                        ...
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('govern_finance_related', {*/}
                                                                     {/*initialValue: _formObject.govern_finance_related,*/}
                                        ...
                                        {/*<Col md={4} xs={4} sm={4}>*/}
                                            {/*<FormItem>*/}
                                                ...
                                                {/*<FormControl disabled={!this.props.isEdit}*/}
                                                             {/*{*/}
                                                                 {/*...getFieldProps('govern_other_sectors', {*/}
                                                                     {/*initialValue: _formObject.govern_other_sectors,*/}
                        ...
                        {/*<div className="steps-action">*/}
                            {/*{*/}
                                {/*<Button colors="primary" style={{marginRight: 8}}*/}
                                        {/*onClick={this.onSubSave.bind(this)}>保存</Button>*/}
                            {/*}{*/}
