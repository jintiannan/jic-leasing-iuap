...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.customerCorpModify.updateState({showLoading: true});
        ...
        async updateRowData(param={},getState){
            ...
            actions.customerCorpModify.updateState({list:_list});
        },
        async saveOrUpdate(formObj) {
            actions.customerCorpModify.updateState({showLoading: true});
            let data = processData(await api.save({data: formObj}));  // 调用 getList 请求数据
            actions.customerCorpModify.updateState({showLoading: false, isEdit: false});
        ...
        async delete (id) {
            ...
            actions.customerCorpModify.updateState({showLoading: false});
            if (data.success) {
        ...
        async getTreeNode() {
            ...
            actions.customerCorpModify.updateState({treeData: data});
        }
    }
};
