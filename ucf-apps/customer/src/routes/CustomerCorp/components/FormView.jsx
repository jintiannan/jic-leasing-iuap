...
class FormView extends Component {
    ...
    componentDidMount() {
        ...
        actions.customerCorp.getTreeNode();
    }
    ...
    onSelect = (info, node) => {
        ...
        if (selectedNode) {
            actions.customerCorp.updateState({subForm:selectedNode.url});
            // this.child.onQuery();
    ...
    render() {
        ...
        let customer = {
            ...
            customerName: this.props.formObject.customerName,
            customerCode: this.props.formObject.customerCode,
            pkCustomer: this.props.formObject.pkCustomer
        };
        ...
        return this.props.isGrid? <div></div>: (
            <div>
                <div>
                    <div style={{width: "13%", height: formHeight, float: "left", overflow: "auto"}}>
                        <Tree className="tree" showLine defaultSelectedKeys={"111"} defaultExpandedKeys={"11"}
                              disabled={true} cancelUnSelect={true} onSelect={this.onSelect} showIcon>
                            {treeNodes}
                        </Tree>
                    </div>
                    <div style={{width: "87%", height: formHeight, float: "left", overflow: "false"}}>
