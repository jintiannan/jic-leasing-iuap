...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.vouchTemplate.updateState({showLoading: true});
            ...
            actions.vouchTemplate.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().vouchTemplate.list;
            ...
            actions.vouchTemplate.updateState({list:_list});
        },
    }
};
