...
export default {
    ...
    effects: {
        ...
        async loadList(param = {}, getState) {
            ...
            actions.calculatorzt.updateState({showLoading: true});
            ...
            actions.calculatorzt.updateState(updateData); // 更新数据和查询条件
        },
        ...
        async updateRowData(param={},getState){
            ...
            let list = getState().calculatorzt.list;
            ...
            actions.calculatorzt.updateState({list:_list});
        },
    }
};
